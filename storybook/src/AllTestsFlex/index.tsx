import { ResultsList, TestResult } from "./results-list";
...
export const AllTestsFlex = () => {
  return (
    <div
      style={{ maxWidth: "1280px", background: "#0D141C", color: "#ffffff" }}
    >
      <ResultsList incoming_data={defaultData} />
    </div>
  );
};
